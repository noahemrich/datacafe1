...
;( function( window ) {
	...
	stepsForm.prototype._initEvents = function() {
		var self = this,
			// first input
			firstElInput = this.questions[ this.current ].querySelector( 'textarea,input' ),
			// focus
		...
		var self = this,
			onEndTransitionFn = function( ev ) {
				...
				if( self.isFilled ) {
					...
					nextQuestion.querySelector( 'textarea,input' ).focus();
				}
			};
	...
	stepsForm.prototype._validade = function() {
		...
		var input = this.questions[ this.current ].querySelector( 'textarea,input' );
